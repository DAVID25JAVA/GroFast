  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
      <div className="my-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-3 mt-5 place-content-center place-items-center">
          {categories?.map((item, index) => (
            <div key={index} className="bg">
              <div
                className={`bg-indigo-200 md:h-48 h-44 flex items-center rounded-lg`}
